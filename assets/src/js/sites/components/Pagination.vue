<template>
    <ul v-if="items && items > perPage" class="inline-flex min-w-1/3 col-span-full mx-auto gap-3 !mb-0">
        <li>
            <span :class="`${hasBack || '!text-gray-400/70 bg-blue-100/90 cursor-default'} cursor-pointer select-none size-12 bg-blue-100 transition-all duration-300 rounded-2xl items-center flex justify-center`"
        ...
        <li v-for="i in pages">
            ...
            <span v-else
                :class="`${page === i && 'cursor-default bg-blue-300'} cursor-pointer select-none size-12 bg-blue-100 transition-all duration-300 rounded-2xl items-center flex justify-center`"
        ...
        <li>
            <span :class="`${hasForward || '!text-gray-400/70 bg-blue-100/90 cursor-default'} cursor-pointer select-none size-12 bg-blue-100 transition-all duration-300 rounded-2xl items-center flex justify-center`"
