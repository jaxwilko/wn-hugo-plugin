<div class="flex cursor-pointer select-none size-12 bg-blue-100 hover:bg-blue-200 transition-all duration-300 rounded-2xl items-center justify-center" onclick="<?= sprintf(
