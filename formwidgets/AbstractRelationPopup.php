...
abstract class AbstractRelationPopup extends FormWidgetBase
{
    public mixed $list;
    public mixed $form;
    ...
    protected Form $popupFormWidget;
    ...
    public function init()
    {
        ...
        if ($this->getPopupModel()) {
            $this->getListWidget();
            $this->getPopupFormWidget();
        }
    }

    abstract protected function getPopupModel();
    ...
    protected function getListWidget(): Lists
    {
        ...
        $widget->bindEvent('list.extendQuery', function ($query) {
            $query->where($this->foreignKey, $this->getPopupModel()->id);
        });
     ...
     */
    protected function getPopupFormWidget(): Form
    {
        if (isset($this->popupFormWidget)) {
            return $this->popupFormWidget;
        }

        // Configure the Form widget
        $config = $this->makeConfig($this->form);
        $config->model = $this->getPopupModel();
        ...
        return $this->popupFormWidget = $widget;
    }
