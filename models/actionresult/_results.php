<?php foreach ($formValue as $entry): ?>
    <div class="hugo-row">
        <?php if ($entry instanceof \JaxWilko\Hugo\Classes\automation\Actions\CommandResult): ?>
                                ...
                                <td>
                                    <?=
                                        match($entry->result->status) {
                                            \JaxWilko\Hugo\Classes\automation\AutomationEngine::STATUS_OKAY => 'Okay',
                                            \JaxWilko\Hugo\Classes\automation\AutomationEngine::STATUS_GENERAL_ERROR => 'General Error',
                                            \JaxWilko\Hugo\Classes\automation\AutomationEngine::STATUS_UNCAUGHT_ERROR => 'Uncaught Error',
                                            \JaxWilko\Hugo\Classes\automation\AutomationEngine::STATUS_NO_EXIT_ERROR => 'Exit Error',
                                        }
                                    ?>
                                </td>
        ...
        <?php elseif ($entry instanceof \JaxWilko\Hugo\Classes\automation\Actions\Screenshot): ?>
        ...
        <?php elseif ($entry instanceof \JaxWilko\Hugo\Classes\automation\Actions\LogEntry): ?>
